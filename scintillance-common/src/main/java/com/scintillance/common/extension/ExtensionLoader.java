...
import com.scintillance.common.util.PriorityComparator;
import com.scintillance.common.util.PropertiesUtil;
...
public class ExtensionLoader<T> {
    ...
    public T getDefaultExtension() {
        if(StringUtil.isEmpty(defaultKey)) {
            throw new SciException("defaultKey is empty");
        }
        return getExtension(defaultKey);
    }
